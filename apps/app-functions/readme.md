...
* `firebase.app-functions.json` - Firebase CLI Configuration for this project
...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp app-functions` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run app-functions:deploy` - Deploy this app to firebase
* `nx run app-functions:serve` - Serve this app using the firebase emulator
* `nx run app-functions:build` - Build all functions associated with this app
* `nx run app-functions:test` - Test all functions associated with this app
* `nx run app-functions:lint` - Lint all functions associated with this app
